    ...
    <body>
        ...
        <div class="container">
            ...
            <form class="form-signin" action="login.php" method="post">
                ...
                <input name="user" type="text" class="input-block-level" placeholder="用户名" value="admin">
                ...
                <input name="s" class="input-block-level hidden" value="0">
                ...
                <button class="btn btn-large" href="#s">注册</button>
            </form>
        ...
        <script>
            $("button[href='#s']").click(function(){
                $("input[name='s']").attr("value","1");
                $("form").submit();
            });
        </script>
    </body>
